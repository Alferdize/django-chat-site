# Generated by Django 2.1.2 on 2019-03-22 21:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('A', 'Video'), ('V', 'Audio'), ('I', 'Image')], max_length=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
                ...
                ('notf_time', models.DateTimeField(default=datetime.datetime.now)),
            ],
            options={
                'ordering': ('notf_time',),
            },
